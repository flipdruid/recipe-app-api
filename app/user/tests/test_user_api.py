...
class PublicUserAPITests(TestCase):
    """"Test the public a user is successful."""
    ...
    def test_user_token_for_user(self):
        """Test generation token for valid credential"""
        user_details = {
            'name': 'Test Name',
            'email': 'test@example.com',
    ...
    def test_create_token_blank_password(self):
        """Test returns error if blank password returns an error."""
